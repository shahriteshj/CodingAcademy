	...
	public static void main(String[] args) {
		...
		try {
			...
			// step 5: commiting the tx
						transaction.commit();
			System.out.println("\n************Customer record with cutName "+ custName+"*************\n");
			hql = "from Customer where custName=:custName";//HQL for retrieving the records
			...
			query=session.createQuery("\nupdate Customer set phone=:phone where custId=:custId");
			...
			System.out.println("\nupdating Customer using HQL with customer id : "+custId);
